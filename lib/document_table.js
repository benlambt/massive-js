...
exports.insertDoc = function(args, next) {
  this.saveDoc('insert', args, next);
}

exports.updateDoc = function() {
  var args, next;
  ...
  this.saveDoc('update', args, next);
}

exports.saveDoc = function(operation, args, next){
  ...
  if (operation === 'update') {
    sql = util.format("update %s set body = $2 where %s = $1 returning *;",this.fullname, pkName);
